        ...
        <ScrollView style={{ flex: 1 }}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.formItem}>
                    <Text>Media Mañana</Text>
                    <TextInput style={styles.input}
                        editable={!isDisabled}
                        selectTextOnFocus={!isDisabled}
                        placeholder='Nivel de Glucosa'
                        value={paper.media_manana}
                        keyboardType='number-pad'
                        onChangeText={(value) => handleChange(value, "media_manana")} />
                </View>
                ...
                <View style={styles.formItem}>
                    ...
                    <TextInput style={styles.input}
                        ...
                        value={paper.rapida_ultra_rap_m}
                        keyboardType='number-pad'
                        onChangeText={(value) => handleChange(value, "rapida_ultra_rap_m")} />
                </View>
